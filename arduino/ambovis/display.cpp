...
void drawY2(Adafruit_ILI9341& tft, uint16_t color);
...
void drawY2(Adafruit_ILI9341& tft, uint16_t color) {// THERE IS NO NEED TO REDRAW ALL IN EVERY FRAME WITH COLOR TFT
